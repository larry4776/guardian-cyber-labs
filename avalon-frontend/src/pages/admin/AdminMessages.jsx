          ...
          <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
            {FILTRES_METHODE.map(f => (
              <button key={f} onClick={() => setActiveMethode(f)} style={{
                ...
                background: activeMethode === f ? '#3b6df0' : 'rgba(255,255,255,0.06)',
                border: activeMethode === f ? '1px solid rgba(59,109,240,0.4)' : '1px solid rgba(255,255,255,0.1)',
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            {FILTRES_PERIODE.map(p => (
              <button key={p} onClick={() => setActivePeriode(p)} style={{
                padding: '8px 14px', borderRadius: '8px',
                background: activePeriode === p ? '#3b6df0' : 'rgba(255,255,255,0.06)',
                border: activePeriode === p ? '1px solid rgba(59,109,240,0.4)' : '1px solid rgba(255,255,255,0.1)',
